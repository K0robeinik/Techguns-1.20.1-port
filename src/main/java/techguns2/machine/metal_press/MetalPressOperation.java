...
public final class MetalPressOperation extends TickedMachineOperation
{
    public final ItemStack primaryItem;
    public final ItemStack secondaryItem;
    public final ItemStack resultItem;
    
    public MetalPressOperation(FriendlyByteBuf buf, boolean fromNetwork)
    {
    ...
    public MetalPressOperation(CompoundTag tag, boolean fromNetwork)
    {
