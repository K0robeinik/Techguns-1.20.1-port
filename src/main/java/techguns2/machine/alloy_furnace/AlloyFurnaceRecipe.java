...
public final class AlloyFurnaceRecipe implements IAlloyFurnaceRecipe
{
    ...
    @Override
    public final boolean matches(AlloyFurnaceBlockEntity blockEntity, Level level)
    {
    ...
    @Override
    public final ItemStack assemble(AlloyFurnaceBlockEntity blockEntity, RegistryAccess access)
    {
    ...
    {
        return TGRecipeSerializers.ALLOY_FURNACE.get();
    }
    
    public static final class Serializer implements RecipeSerializer<AlloyFurnaceRecipe>
    {
        protected final AlloyFurnaceRecipe readJson(ResourceLocation recipeId, JsonObject json)
        {
            ...
            return new AlloyFurnaceRecipe(recipeId, group, primaryIngredient, secondaryIngredient, result, processingTime, energyDrainPerTick);
        }
        
        protected final void writeJson(JsonObject json, AlloyFurnaceRecipe recipe)
        {
        ...
        protected final void writeJson(JsonObject json, AlloyFurnaceRecipe.Builder.Result recipe)
        {
        ...
        private final AlloyFurnaceRecipe readFromBuffer(ResourceLocation recipeId, FriendlyByteBuf buffer)
        {
        ...
        private final void writeToBuffer(FriendlyByteBuf buffer, AlloyFurnaceRecipe recipe)
        {
        ...
        @Override
        public final AlloyFurnaceRecipe fromJson(ResourceLocation recipeId, JsonObject json)
        {
        ...
        @Override
        @Nullable
        public final AlloyFurnaceRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer)
        {
            return this.readFromBuffer(recipeId, buffer);
        }

        @Override
        public final void toNetwork(FriendlyByteBuf buffer, AlloyFurnaceRecipe recipe)
        {
    ...
    public static final class Builder implements RecipeBuilder
    {
        ...
        public static final class Result implements FinishedRecipe
        {
            ...
            private Result(Builder builder, ResourceLocation id)
            {
                ...
                {
                    prefix = "recipes/misc/alloy_furnace/";
                }
                else
                {
                    ...
                    RecipeSerializerUtil.ItemStackResult result)
            {
                this(
                        ...
                        energyDrainPerTick,
                        advancement,
                        id.withPrefix("recipes/misc/alloy_furnace/"),
                        result);
            }
